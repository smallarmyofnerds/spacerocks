...
class Spaceship(GameObject):
    ...
    def __init__(self, position, create_bullet_callback):
        ...
        spaceship = load_sprite("spaceship")
        re_spaceship = pygame.transform.scale(spaceship, (50, 70))
        super().__init__(position, re_spaceship, Vector2(0))
...
class Bullet(GameObject):
    def __init__(self, position, velocity):
        ...
        re_bullet = pygame.transform.scale(bullet, (10, 10))
